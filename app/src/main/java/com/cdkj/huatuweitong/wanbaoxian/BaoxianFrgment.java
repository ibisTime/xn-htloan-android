...
/**
 * @author : qianLei
 * @since : 2019/11/4 11:28
 */
public class BaoxianFrgment extends BaseLazyFragment {

    private FrgBaoxianBinding mBinding;

    private FenqiAdapter pagerAdapter;
    private List<MainResourceBean.ListBean> list = new ArrayList<>();

    public static BaoxianFrgment getInstance() {
        BaoxianFrgment fragment = new BaoxianFrgment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBinding = DataBindingUtil.inflate(inflater, R.layout.frg_baoxian, null, false);
    ...
    private void initListener() {
        ...
        mBinding.btnConfirm.setOnClickListener(view -> {
            ...
            CarApplyActivity.open(mActivity, CarApplyActivity.BAOXIAN);
        });
    ...
    private void getData() {
        ...
        map.put("bizCode", "RT201911011052165353997");
        map.put("kind", "");
        map.put("location", "1");
        map.put("status", "1");
        map.put("start", "1");
