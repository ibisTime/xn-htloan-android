...
public class CarSystemListAdapter extends BaseQuickAdapter<CarSystemBean, BaseViewHolder> {

    public CarSystemListAdapter(@Nullable List<CarSystemBean> data) {
...
//        item.getOutsideColor
        ...
        helper.setText(R.id.tv_price, MoneyUtils.formatNum(item.getLowest()) + "元-" + MoneyUtils
                .formatNum(item.getHighest()) + "元");
    }
}
