 ...
 * @updateDts 2019/3/13
 */
public class CarPageAdapter extends BaseQuickAdapter<CarBean, BaseViewHolder> {
    public CarPageAdapter(@Nullable List<CarBean> data) {
        super(R.layout.item_car_page, data);
    }
