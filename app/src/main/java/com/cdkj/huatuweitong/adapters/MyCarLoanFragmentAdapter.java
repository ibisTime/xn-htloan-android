...
//        }
        ...
        helper.setText(R.id.tv_total_money, "总价: " + MoneyUtils.showPriceDouble(item.getPrice()));
        helper.setText(R.id.tv_one_pay, "首付: " + MoneyUtils.showPriceDouble(item.getSfAmount()));
        ImageView ivLogo = helper.getView(R.id.iv_logo);
        ImgUtils.loadImg(mContext,"",ivLogo);
//        iv_logo
    }
}
