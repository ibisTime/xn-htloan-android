...
public class WxUtil {
    ...
    public static final String APPID = "wx14ce9b413e063005";
...
//        boolean isPaySupported = api.isWXAppInstalled() && api.isWXAppSupportAPI();
    ...
    public static void shareToPYQ(Context context, String url, String title, String description) {
        ...
        try {
            Bitmap bmp1 = BitmapFactory.decodeResource(context.getResources(), R.mipmap.app_logo);
...
//        Bitmap bmp1 = BitmapFactory.decodeResource(context.getResources(), R.mipmap.logo);
        Bitmap bmp1 = Bytes2Bimap(bitmap);
        Bitmap thumbBmp = Bitmap
                .createScaledBitmap(bmp1, bmp1.getWidth() / 5, bmp1.getHeight() / 5, true);
