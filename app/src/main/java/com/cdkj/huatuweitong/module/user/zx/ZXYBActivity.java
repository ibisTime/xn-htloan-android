...
import com.cdkj.huatuweitong.databinding.ActivityZxybBinding;
 ...
 * 社保认证
 */
public class ZXYBActivity extends AbsBaseLoadActivity {
    ActivityZxybBinding mBinding;
    public List<SBAreaListBean> addressList;//地区列表
    private int options = -1;

    public static void open(Context context) {
        if (context != null) {
            Intent intent = new Intent(context, ZXYBActivity.class);
    ...
    public View addMainView() {
        mBinding = DataBindingUtil.inflate(getLayoutInflater(), R.layout.activity_zxyb, null, false);
    ...
    public void afterCreate(Bundle savedInstanceState) {
        mBaseBinding.titleView.setMidTitle("社保");
        initOnClick();
    }
    ...
    private void initOnClick() {
        ...
        mBinding.rMLArea.setOnClickListener(v -> {
            ...
            Call<BaseResponseListModel<SBAreaListBean>> zxsbArea = RetrofitUtils.createApi(MyApiServer.class).getZXSBArea("632925", "{}");
            showLoadingDialog();
...
//    SBAreaListBean zxSuccessBean = JSON.parseObject(data, new TypeReference<SBAreaListBean>() {
//    });
//                    if (zxSuccessBean == null) {
//        UITipDialog.showInfo(ZXYBActivity.this, "认证失败请重试");
//        return;
//    }
//                    if (TextUtils.equals(zxSuccessBean.getCode(), "0000")) {
//        //成功
//        addressList = zxSuccessBean;
//        shoAddressDialog();
//    } else {
//        UITipDialog.showInfo(ZXYBActivity.this, zxSuccessBean.getMsg());
//    }
    ...
    private boolean check() {
        ...
        if (options < 0 || addressList == null || addressList.size() == 0) {
    ...
    private void submit() {
        ...
        map.put("realName", SPUtilHelper.getUserName());//真实姓名
        map.put("username", mBinding.myELUsername.getText());//账号
        map.put("idNo", SPUtilHelper.getIdCarde());//身份证号  从用户详情中取
        map.put("customerName", SPUtilHelper.getRealName());//姓名  从用户详情中取
        Call<BaseResponseModel<String>> zxid = RetrofitUtils.createApi(MyApiServer.class).getZXRZ2("632927", StringUtils.getJsonToString(map));
        showLoadingDialog();
        zxid.enqueue(new BaseResponseModelCallBack<String>(this) {
            ...
            protected void onSuccess(String data, String SucMessage) {
                ...
                if (TextUtils.equals(zxSuccessBean.getCode(), "0010")) {
                    UITipDialog.showSuccess(ZXYBActivity.this, "成功", dialog -> finish());
                } else {
                    UITipDialog.showInfo(ZXYBActivity.this, zxSuccessBean.getMsg());
                }
            }
