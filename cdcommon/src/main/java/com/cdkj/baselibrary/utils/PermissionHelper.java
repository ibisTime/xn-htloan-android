...
public class PermissionHelper {
    ...
    public void showMessageOKCancel(CharSequence message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder(getActivity(mContext))
                .setMessage(message)
                .setPositiveButton(CdApplication.getContext().getString(R.string.sure), okListener)
                .setNegativeButton(CdApplication.getContext().getString(R.string.cancel), null)
                .create()
                .show();
    }
