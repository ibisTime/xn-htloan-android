 ...
 * 这个是  大数据接口使用的  不判断  token失效
 */
public abstract class BaseResponseModelNoTokenCallBack<T> implements Callback<BaseResponseModel<T>> {

    private Context context;

    public BaseResponseModelNoTokenCallBack(Context context) {
